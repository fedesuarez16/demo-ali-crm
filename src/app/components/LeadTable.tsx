...
const LeadTable: React.FC<LeadTableProps> = ({ leads }) => {
  if (leads.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-12 px-44 bg-slate-800">
          ...
          <div key={col} className="min-w-[260px]">
            ...
            <div className="space-y-2">
              {grouped[idx].length === 0 ? (
                <div className="text-xs text-slate-400 border border-dashed border-slate-200 rounded-md py-6 text-center">Vacío</div>
              ) : (
